...
<head>
    ...
    <title>PrivSpot/dairy/dentry</title>
...
<body>
    <div class="navbar">
        ...
        <div class="body">
            ...
            <div class="form">
                <div class="date">
                    <p><b>Date: </b><?= date('jS F Y') ?></p>
                    <p><b>Day: </b><?= date("l") ?></p>
                </div>
                <form action="dentry.php" method="post">
                    <textarea name="data" rows="23" cols="94" placeholder="Dear Dairy !!!............"></textarea>
...
<?php
    ...
    if(count($_SESSION)>0){
        ...
        $sql="SELECT * FROM dairy WHERE uname = '".$uname."' AND date = CURDATE() ";
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $sql="INSERT INTO dairy ( uname, data ) VALUES ('".$uname."', '".$d."')";
            $r=mysqli_query($con,$sql);
