...
<head>
    ...
    <link rel="stylesheet" href="./../../css/notes/nview.css">
                ...
                <div class="form1">
                   <center>
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        echo '<button id="edit"><a href="nupdate.php?id='.$r[0].'">Edit</a></button>';
                        echo '<p id="title">'.$r[1].'</p>';
                        
                        echo '<div id="matter"><pre><p>'.$r[2].'</p></pre></div>';
