...
<body>
    <div class="navbar">
        ...
        <ul class="items">
            ...
            <li><a href="notes.php"><i class="fa fa-pencil-square" aria-hidden="true"></i> Notes</a></li>
    ...
    <div class="body">
        <div class="content">
            ...
            <div class="item2">
                <center><h3>Notes Editor</h3></center>
                <div class="form">
                <?php
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $s="SELECT * FROM notes WHERE nid = ".$id;
                        $r=mysqli_query($con,$s);
                        if(!$r){
                            echo "<script>console.log('fetching error');</script>";
                            exit;
                        }
                        $r=mysqli_fetch_array($r);
                        echo '<center> <form action="nupdatesaver.php" method="post">
                        <input type="text" name="title" placeholder="   eg:title1" id="t" value="'.$r[1].'">
                        <textarea rows="21" cols="20" name="data" placeholder="note point1: " id="d" required>'.$r[2].'</textarea>
                        <input type="number" name="id" value="'.$r[0].'" id="id">
